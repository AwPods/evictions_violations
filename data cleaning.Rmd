...
pal_uhf_evic_2017 <- colorNumeric("Blu", 
                     domain = uhf_evic_2017$counts,
                     reverse = FALSE)

pal_uhf_evic_2018 <- colorNumeric("Blu", 
                     domain = uhf_evic_2018$counts,
                     reverse = FALSE)

pal_uhf_evic_2019 <- colorNumeric("Blu", 
                     domain = uhf_evic_2019$counts,
                     reverse = FALSE)

pal_uhf_evic_2020 <- colorNumeric("Blu", 
                     domain = uhf_evic_2020$counts,
                     reverse = FALSE)

pal_uhf_evic_2021 <- colorNumeric("Blu", 
                     domain = uhf_evic_2021$counts,
                     reverse = FALSE)

pal_uhf_evic_2022 <- colorNumeric("Blu", 
                     domain = uhf_evic_2022$counts,
                     reverse = FALSE)

pal_uhf_evic_2023 <- colorNumeric("Blu", 
                     domain = uhf_evic_2023$counts,
                     reverse = FALSE)

pal_uhf_evic_2024 <- colorNumeric("Blu", 
                     domain = uhf_evic_2024$counts,
                     reverse = FALSE)
# Add the layer 
map_tiles |> 
...
# Add layers for the two datasets
map_tiles <- map_tiles |>
  addPolygons(data = uhf_evic,
