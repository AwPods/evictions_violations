...
for (year in years) {
  ...
  map_tiles <- map_tiles |>
    ...
    addLegend(
      ...
      title = HTML(paste0("<span style='font-size:10px;'>Number of Evictions ", year, "</span>")),
...
map_tiles <- map_tiles |>
  ...
  addLegend(
    ...
    title = HTML("<span style='font-size:10px;'>Total Number of Evictions</span>"),
    position = "bottomleft",
    group = "Total Evictions"  # Link the legend to the total evictions layer
  )

# Add layer controls and hide all groups initially
map_tiles <- map_tiles |>
  addLayersControl(
    baseGroups = c("Total Evictions", paste0("Evictions ", years)),  # Add all layers to control
    options = layersControlOptions(collapsed = FALSE)
  ) |>
  hideGroup(c("Total Evictions", paste0("Evictions ", years)))  # Hide all layers and legends initially
...
for (year in years) {
  assign(paste0("quantile_breaks", year)) = classintervals(paste0("uhf_evic_", year)$counts, n=5, style = "quantile")
}
